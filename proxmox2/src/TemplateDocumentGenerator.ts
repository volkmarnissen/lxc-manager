...
export class TemplateDocumentGenerator {
  ...
  constructor(templatesDir: string = path.join('json', 'shared', 'templates'), docsDir: string = 'docs', schemaPath: string = path.join('schemas', 'shared.application.schema.json')) {
  ...
  private generateDocForTemplate(templatePath: string, paramDefs: any, paramOrder: string[]): TemplateDoc {
