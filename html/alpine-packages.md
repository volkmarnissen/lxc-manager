...
Provision an Alpine-based LXC with full APK build toolchain (alpine-sdk) and git.
...
|----------|-------------|--------|
| [set-ostype.json](json/applications/alpine-packages/templates/set-ostype.md) | Sets the OS type for the Alpine build environment | ✓ Executed |
...
| [300-install-alpine-build-tools.json](json/applications/alpine-packages/templates/300-install-alpine-build-tools.md) | Install alpine-sdk (build toolchain) and git for building APK packages | ✓ Executed |
...
| 14 | `Update indexes` | - | ✓ Executed |
| 15 | `Install toolchain` | alpine-sdk includes abuild, build-base, and related tools | ✓ Executed |
...
- See [set-ostype.json](json/applications/alpine-packages/templates/set-ostype.md) for details
...
- See [300-install-alpine-build-tools.json](json/applications/alpine-packages/templates/300-install-alpine-build-tools.md) for details
